#!/usr/bin/env python3
"""
Recuperation des codes promo Atida depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/atida.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/atida.fr"
STORE_NAME = "Atida"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Atida depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-atida)"
    }
    try:
